...
let serviceDetails = [
  ...
  },
  {
    ...
    paragraph:
      "At BlueBillionaire.ai, we recognize that every organization is unique, with its own set of challenges and objectives. Our custom software development services are designed to create tailored solutions that streamline operations, enhance productivity, and drive business growth, ensuring our clients remain competitive in an ever-evolving marketplace.",

    paragraphTwo:
      "The foundation of effective custom software development lies in a deep understanding of our clients’ needs. At BlueBillionaire.ai, we prioritize collaboration, working closely with businesses to identify their specific challenges and goals. This approach allows us to gain insights into the intricacies of your operations, ensuring that the software we develop is perfectly aligned with your strategic objectives. Whether it’s automating processes, improving user experience, or enhancing data management, we are committed to delivering solutions that truly address your requirements.",
  },
  {
    ...
    paragraph:
      "At BlueBillionaire.ai, we specialize in providing comprehensive IT infrastructure services designed to support your growth ambitions and enhance operational efficiency. Our team of experts is dedicated to creating a solid technological foundation that empowers organizations to thrive in a competitive landscape.The journey to a resilient IT infrastructure begins with strategic planning. At BlueBillionaire.ai, we conduct thorough assessments of your current IT environment to identify strengths, weaknesses, and opportunities for improvement.",
  ...
  },
  {
    ...
    paragraph:
      "At BlueBillionaire.ai, we recognize that protecting your business's sensitive information and critical infrastructure is paramount to maintaining trust, reputation, and operational continuity. Our comprehensive cybersecurity solutions are designed to empower organizations to navigate the evolving landscape of cyber threats with confidence.",

    paragraphTwo:
      "Cyber threats are becoming increasingly sophisticated, ranging from data breaches and ransomware attacks to phishing schemes and insider threats. At BlueBillionaire.ai, we begin our cybersecurity services with a thorough understanding of the unique threats facing your industry and organization. Our team of experts conducts meticulous assessments to identify vulnerabilities within your systems, enabling us to develop targeted strategies that effectively mitigate risks.",
  },
  {
